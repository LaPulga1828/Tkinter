...
Frame_entrada.config(bg='white',width=780 ,height=160 )
...
Frame_operaciones.config(bg='blue',width=780 ,height=160 )
Frame_operaciones.place(x=10,y=170)
...
Frame_resultados.config(bg='red',width=780 ,height=160)
